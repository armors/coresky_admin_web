<template>
  <div class="config-group">
    <div style="text-align: right">
      <el-button :loading="loading" v-permission="['*']" type="danger" v-if="editKey !== 'edit'" @click="editConfig">
        {{ $t("global.edit") }}</el-button>
      <el-button :loading="loading" v-permission="['*']" type="primary" v-if="editKey === 'edit'" @click="updateConfig">
        {{ $t("global.save") }}</el-button>
      <el-button :loading="loading" v-permission="['*']" v-if="editKey === 'edit'" @click="cancelConfig()">

<template>
  <div class="config-group">
    ...
    <config-item :label="$t('config.lastBlock')" dataKey="lastBlock" :editKey="editKey" @setEditKey="editKey = $event"
      @clearEditKey="editKey = ''">
      <template #default="{ config }">
        <el-input v-model="config.lastBlock"></el-input>
      </template>
    </config-item>
    <config-item :label="$t('config.blockConfirmation')" dataKey="blockConfirmation" :editKey="editKey"
      @setEditKey="editKey = $event" @clearEditKey="editKey = ''">
      <template #default="{ config }">
        <el-input v-model="config.blockConfirmation"></el-input>
      </template>
    </config-item>
    <config-item :label="$t('config.maxBlockOneTime')" dataKey="maxBlockOneTime" :editKey="editKey"
      @setEditKey="editKey = $event" @clearEditKey="editKey = ''">
      <template #default="{ config }">
...
import { txorderInfo } from '@/api/common'
export default {
  name: 'SyncBlock',
  components: {
    ConfigItem

<template>
  <div class="app-container">
    <el-row :gutter="10" class="mb15">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleCreate">{{ $t("sortManagement.create") }}</el-button>
      </el-col>
    </el-row>
    <!-- 查询结果 -->
    <el-table v-loading="listLoading" size="small" :data="list" :element-loading-text="$t('sortManagement.loadingText')" border fit

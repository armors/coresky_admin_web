<template>
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="list" :element-loading-text="$t('global.loadingText')" border
      ...
      <el-table-column align="center" :label="$t('global.operation')" width="120"
        class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button type="primary" size="mini" @click="handleUpdate(scope.row)"
            v-permission="['POST /admin/contract/update']">{{ $t("global.edit") }}</el-button>
...
import { categoryList, contractList, contractCreate, contractUpdate, contractDelete, storageCreate } from '@/api/common'

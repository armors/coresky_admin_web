<template>
  <div>
    ...
    <el-table v-loading="loading" :data="dataList" size="small">
      ...
      <el-table-column label="项目介绍" align="center" prop="itemTypeNm" />
      <el-table-column label="跳转链接" align="center" prop="areaNm" />
      <el-table-column label="图片" align="center" prop="byRatio">
    ...
    <el-dialog title="首页开屏区配置" :visible.sync="open" width="600px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="120px" size="small" style="margin-right:45px">
        <el-form-item label="大标题内容" prop="areaNm">
          <el-input v-model="form.areaNm" placeholder="请输入大标题内容" />
        </el-form-item>
        <el-form-item label="子标题内容" prop="areaNm">
          <el-input v-model="form.areaNm" type="textarea" :rows="3" placeholder="请输入子标题内容" />
        </el-form-item>
        <el-form-item label="链接地址" prop="areaNm">
          <el-input v-model="form.areaNm" placeholder="请输入链接地址" />
        </el-form-item>
        <el-form-item label="图片" prop="areaNm">

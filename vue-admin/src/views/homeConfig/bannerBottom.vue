<template>
  <div>
    ...
    <el-table v-loading="loading" :data="dataList" size="small">
      ...
      <el-table-column label="合约名称" align="center" prop="deptNm" />
      <el-table-column label="合约地址" align="center" prop="deptNm" />
      <el-table-column label="封面图" align="center" prop="byRatio">
